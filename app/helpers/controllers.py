...
'''
everday categories inspired by emotion_ml section
'''
...
'''
occ categories inspired by emotion_ml section
'''
occ-categories = ['admiration', 'anger', 'disappointment', 'distress', 'fear', 'dread' , 'triumph', 'gratification', 'gratitude', 'appreciation', 'hate' , 'hope', 'joy', 'love', 'pity' , 'pride', 'relief' , 'remorse' , 'reproach', 'resentment', 'satisfaction', 'embarrassment']
...
def process_emotion_set(doc, lang, emotion_set, natural, stemmer, lemma):
    ...
    if emotion_set == 'big_6':
        e_set = big_6
    if emotion_set == 'everday_categories':
        e_set = everday_categories
    if emotion_set == 'occ-categories':
        e_set = occ-categories
